			...
			<?php 
				for($i=0;$i<$num_paginas;$i++){
				    ...
				    if($pagina == $i)
				    	$estilo = "class=\"active\"";
			?>
			<li <?php echo $estilo; ?> ><a href="Ver-chamados-admin.php?pagina=<?php echo $i; ?>"><?php echo $i+1; ?></a></li>
				<?php } ?>
				<li>
					<a href="Ver-chamados-admin.php?pagina=<?php echo $num_paginas-1; ?>" aria-label="Next">
