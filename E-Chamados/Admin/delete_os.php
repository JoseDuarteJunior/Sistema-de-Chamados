    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
		  ...
		  <a class="btn btn-danger btn-lg" href="Deletar-chamado-admin.php">
   Entendido
</a>
        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
		  ...
		  <a class="btn btn-sucess btn-lg" href="Deletar-chamado-admin.php">
   Entendido
</a>
        </div>
...
$sql = "DELETE FROM chamados1 WHERE contador='$numero_os'";
