...
<div class="container">
  ...
  <nav>
				  <ul class="pagination">
				    <li>
				      <a href="Ver-chamados-tec.php?pagina=0" aria-label="Previous">
				    ...
				    if($pagina == $i)
				    	$estilo = "class=\"active\"";
				    ?>
				    <li <?php echo $estilo; ?> ><a href="Ver-chamados-tec.php?pagina=<?php echo $i; ?>"><?php echo $i+1; ?></a></li>
					<?php } ?>
				    <li>
				      <a href="Ver-chamados-tec.php?pagina=<?php echo $num_paginas-1; ?>" aria-label="Next">
